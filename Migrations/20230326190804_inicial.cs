    ...
    public partial class inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EstadoCompraId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    EstadoDeCompra = table.Column<string>(type: "TEXT", nullable: false),
                    Estado = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EstadoCompra", x => x.EstadoCompraId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EstadoVentaId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    EstadoDeVenta = table.Column<string>(type: "TEXT", nullable: false),
                    Estado = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EstadoVenta", x => x.EstadoVentaId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Estado = table.Column<bool>(type: "INTEGER", nullable: false),
                    EstadoDeLaCompra = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PagoId = table.Column<int>(type: "INTEGER", nullable: true),
                    EstadoVentaId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ventas", x => x.VentaId);
                    table.ForeignKey(
                        name: "FK_Ventas_EstadoVenta_EstadoVentaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroOrden = table.Column<double>(type: "REAL", nullable: false),
                    MetodoPago = table.Column<string>(type: "TEXT", nullable: false),
                    Estatus = table.Column<string>(type: "TEXT", nullable: false),
                    CantidadComprada = table.Column<double>(type: "REAL", nullable: false),
                    CantidadAumentada = table.Column<double>(type: "REAL", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArticuloId = table.Column<int>(type: "INTEGER", nullable: false),
                    PagoId = table.Column<int>(type: "INTEGER", nullable: false),
                    NombreDetalle = table.Column<string>(type: "TEXT", nullable: true),
                    CantidadDetalle = table.Column<double>(type: "REAL", nullable: false),
                    PrecioDetalle = table.Column<decimal>(type: "TEXT", nullable: false),
                    ImporteDetalle = table.Column<decimal>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompraDetalle", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompraDetalle_Articulo_ArticuloId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrecioArticuloComprado = table.Column<decimal>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "EstadoCompra",
                columns: new[] { "EstadoCompraId", "Estado", "EstadoDeCompra" },
                values: new object[] { 1, true, "En espera" });

            migrationBuilder.InsertData(
                table: "EstadoCompra",
                columns: new[] { "EstadoCompraId", "Estado", "EstadoDeCompra" },
                values: new object[] { 2, true, "Solicitado" });

            migrationBuilder.InsertData(
                table: "EstadoCompra",
                columns: new[] { "EstadoCompraId", "Estado", "EstadoDeCompra" },
                values: new object[] { 3, true, "Finalizado" });

            migrationBuilder.InsertData(
                table: "EstadoVenta",
                columns: new[] { "EstadoVentaId", "Estado", "EstadoDeVenta" },
                values: new object[] { 1, true, "En espera" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Compra_PagoId",
                table: "Compra",
                column: "PagoId");

            migrationBuilder.CreateIndex(
                name: "IX_CompraDetalle_ArticuloId",
                table: "CompraDetalle",
                column: "ArticuloId");
